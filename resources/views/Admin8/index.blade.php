                                ...
                                <div class="card-body">
                                    <div class="changeDem">
                                        <div class="adjustTablePage">
                                            ...
                                            <a href="{{route('8poroito_Admin.jobs')}}" class="text-primary btnHome">Ver todos <i class="mdi mdi-arrow-right"></i></a>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="sectionChart">
                                        <select class="form-select select2 form-select-ajax" name="marca">
                                            <option value="">Marca</option>
                                            @foreach($brands as $b)
                                                <option value="{{$b->id}}">{{$b->nome}}</option>
                                            @endforeach
                                        </select>
                                        <select class="form-select select2 form-select-ajax" name="agencia">
                                            <option value="">Agência</option>
                                            @foreach($agencys as $c)
    ...
    $(document).ready(function() {
        ...
        $('.form-select-ajax').on('change', function() {
            ...
            function atualizarGrafico() {
                $.ajax({
                    url: '/flow/8poroito/atualizar-grafico',
                    type: 'GET',
                    dataType: 'json',
                    data: {

                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form style="margin-top: 15px" method="POST" action="{{route('Admin.agencia_editar_action', ['id' => $agencia->id])}}" enctype="multipart/form-data" class="needs-validation responseAjax" novalidate>
                                        @csrf
                                        <div class="mb-3 row">

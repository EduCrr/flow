                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form style="margin-top: 15px" method="POST" action="{{route('Admin.marca_editar_action', ['id' => $marca->id])}}" enctype="multipart/form-data" class="needs-validation responseAjax" novalidate>
                                        @csrf
                                        <div class="mb-3 row">

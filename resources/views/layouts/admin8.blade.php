...
<body class="sidebar-enable vertical-collpsed">
    <header id="page-topbar">
        <div class="navbar-header">
            <div class="d-flex">
                <div class="navbar-brand-boxx" style="width: 15px; padding: 0px">
                    <a href="{{ route('8poroito_Admin')}}" class="logo logo-dark">
                ...
                <div class="d-none d-sm-block ms-1">
                    <a
                    href="{{route('8poroito_Admin')}}"
                    style="display: flex; align-items: center"
                    class="btn header-item noti-icon waves-effect {{ Request::is('8poroito/admin') ? 'btnActive' : 'btnNotActive'  }}"
                    >
                        Home
                    </a>
                </div>
                <div class="d-none d-sm-block ms-1">
                    <div class="dropdown">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                            ...
                            <span class="d-none d-xl-inline-block ms-1 {{  Request::is('8poroito/admin/jobs', '8poroito/admin/etapas') ? 'btnActive' : 'btnNotActive' }} ">Jobs gerais</span>
                            <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                        </button>
                        <div class="dropdown-menu">
                            <a href="{{route('8poroito_Admin.jobs')}}" class="dropdown-item">Jobs</a>
                            <a href="{{route('8poroito_Admin.Etapas')}}" class="dropdown-item">Etapas</a>
                        </div>
                    </div>
                </div>
                <div class="d-none d-sm-block ms-1">
                    <div class="dropdown">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="mdi mdi-plus-box-multiple"></i>
                            <span class="d-none d-xl-inline-block ms-1 {{  Request::is('8poroito/admin/agencias', '8poroito/admin/agencia/*') ? 'btnActive' : 'btnNotActive' }} ">Agências</span>
                            <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                        </button>
                        <div class="dropdown-menu">
                ...
                <div class="d-none d-sm-block ms-1">
                    <div class="dropdown">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="mdi mdi-plus-box-multiple"></i>
                            <span class="d-none d-xl-inline-block ms-1 {{  Request::is('8poroito/admin/marcas', '8poroito/admin/marca/*') ? 'btnActive' : 'btnNotActive' }} ">Marcas</span>
                            <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                        </button>
                        <div class="dropdown-menu">
                ...
                <div class="d-none d-sm-block ms-1">
                    <div class="dropdown">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="mdi mdi-plus-box-multiple"></i>
                            <span class="d-none d-xl-inline-block ms-1 {{  Request::is('8poroito/admin/usuarios', '8poroito/admin/usuario/*') ? 'btnActive' : 'btnNotActive' }} ">Usuários</span>
                            <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                        </button>
                        <div class="dropdown-menu">
                ...
                <div class="d-none d-sm-block ms-1">
                    <a
                    href="{{route('Atualizacoes.index')}}"
                    style="display: flex; align-items: center"
                    class="btn header-item noti-icon waves-effect {{  Request::is('atualizacoes', 'atualizacoes*') ? 'btnActive' : 'btnNotActive' }}"
                    >
                       Atualizações @if($atualizationUser > 0)<span class="badge bg-danger rounded-pill adjustBadge"> {{$atualizationUser}} </span>@endif
                    </a>
                </div>
            </div>
            <!-- Search input -->
            <div class="search-wrap" id="search-wrap">
                <div class="search-bar">
                    <form method="get" action="{{route('8poroito_Admin.jobs')}}">
                        <input class="search-input form-control" name="jobId" type="number" placeholder="Pesquisar pelo id do job...">
            ...
            <div class="d-flex">
                                            ...
                                            <div class="d-flex align-items-start {{ $item->visualizada == 1 ? 'notifyContent' : '' }}">
                                                <div class="avatar-xs me-3">
                                                    <span class="avatar-title bg-primary rounded-circle font-size-16 avatar-notify">
                                                        @if($item->tipo === 'criada' || $item->tipo === 'pauta' || $item->tipo === 'entregue' || $item->tipo === 'finalizado' || $item->tipo === 'reaberto' || $item->tipo === 'convidado')
                                                        ...
                                                        @elseif($item->tipo === 'alterado')
                                                            <i class="mdi mdi-comment-outline text-info"></i>
                                                        @elseif($item->tipo === 'congelado')
                                                            <i class="mdi mdi-pause text-info"></i>
                                                        @endif
                                                    </span>
                                                </div>
                                                <div class="flex-1">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{route('8poroito_Admin.jobs')}}"><i class="mdi mdi-book me-2 font-size-16"></i>
                            Jobs
                        </a>
        ...
        <div data-simplebar class="h-100">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="{{ route('8poroito_Admin') }}" class="waves-effect">
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span>Jobs gerais</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('8poroito_Admin.jobs')}}" class="dropdown-item">Jobs </a></li>
                            <li><a href="{{route('8poroito_Admin.Etapas')}}" class="dropdown-item">Etapa 2 </a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">

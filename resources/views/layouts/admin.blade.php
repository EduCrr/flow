        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <!-- <div class="d-none d-sm-block ms-1">
                    ...
                    class="btn header-item noti-icon waves-effect {{ Request::is('admin') ? 'btnActive' : 'btnNotActive'  }}"
                    >
                        <button
                            type="button"
                        ...
                        >
                            <i class="mdi mdi-home me-1 font-size-16"></i> 
                        </button>
                        Home
                    </a>
                </div>
                <div class="d-none d-lg-inline-block">
                    <a
                    href="{{route('Job.criar')}}"
                    style="display: flex; align-items: center"
                    class="btn header-item noti-icon waves-effect {{ Request::is('dashboard/jobs', 'dashboard/criar/*','dashboard/job/*' ) ? 'btnActive' : 'btnNotActive'  }}"
                    >
                    <button
                        type="button"
                        class="btn header-item noti-icon waves-effect"
                        data-bs-target="#search-wrap"
                    >
                        <i class="mdi mdi-book me-1 font-size-16"></i> 
                    </button>
                        Criar job
                    </a>
                </div>
                <div class="d-none d-lg-inline-block">
                    ...
                    >
                        <button
                            ...
                            data-bs-target="#search-wrap"
                        >
                            <i class="mdi mdi-autorenew me-1 font-size-16"></i> 
                        </button>
                ...
                <div class="d-none d-lg-inline-block">
                    <button
                        ...
                        data-bs-target="#search-wrap"
                    >
                        <i class="mdi mdi-home me-2 font-size-16"></i> <a class="{{ Request::is('admin') ? 'btnActive' : 'btnNotActive'  }}" href="{{route('index')}}">Home</a>
                    </button>
                </div>
                <div class="d-none d-sm-block ms-1">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="{{route('Admin.jobs')}}" class="dropdown-item">Filtrar jobs criados </a>
                            <a href="{{route('Admin.Etapas')}}" class="dropdown-item">Etapa 2 </a>
                        </div>
                    </div>
                </div>
                <div class="d-none d-lg-inline-block">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                            ...
                            <div class="p-3">
                                ...
                                @else
                                    <h6 class="m-0 text-center">Todas as notificações foram lidas</h6>
                                @endif
                            </div>
                                                ...
                                                <div class="d-flex align-items-start {{ $item->visualizada == 1 ? 'notifyContent' : '' }}">
                                                    <div class="avatar-xs me-3">
                                                        <span class="avatar-title bg-primary rounded-circle font-size-16 avatar-notify">
                                                            @if($item->tipo === 'criada' || $item->tipo === 'pauta' || $item->tipo === 'convidado' || $item->tipo === 'entregue' ||  $item->tipo === 'finalizado' || $item->tipo === 'reaberto' || $item->tipo === 'criada-coloborador')
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            <i class="mdi mdi-plus-box-multiple me-1 font-size-16"></i>
                            <span>Jobs gerais</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('Admin.jobs')}}" class="dropdown-item">Jobs </a></li>
                            <li><a href="{{route('Admin.Etapas')}}" class="dropdown-item">Etapa 2 </a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ route('Job.criar') }}" class="waves-effect">
                            <i class="mdi mdi-book me-1 font-size-16"></i>
                    ...
                    <li>
                        <a href="{{ route('Atualizacoes.index') }}" class="waves-effect">
                            <i class="mdi mdi-autorenew me-1 font-size-16"></i>
                            <span>
                                Atualizações                     
                            </span>

                    ...
                    <div class="d-none d-sm-block ms-1">
                        <div class="dropdown">
                            <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                                ...
                                <span class="d-none d-xl-inline-block ms-1 {{ Request::is('agencia/jobs', 'agencia/criar/*','agencia/etapas' ) ? 'btnActive' : 'btnNotActive'  }}">Criar Jobs</span>
                                <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                            </button>
                            <div class="dropdown-menu">
                                <a href="{{route('Agencia.criar')}}" class="dropdown-item">Criar novo job </a>
                                <a href="{{route('Agencia.Jobs')}}" class="dropdown-item">Filtrar jobs criados </a>
                    ...
                    @if($isAdminAg > 0)
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                <i class="mdi mdi-book-edit me-1 font-size-16"></i>
                                <span>Criar job</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{route('Agencia.criar')}}" class="dropdown-item">Criar novo job </a></li>
                                <li> <a href="{{route('Agencia.Jobs')}}" class="dropdown-item">Filtrar jobs criados </a></li>

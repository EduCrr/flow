    ...
    <thead>
        <tr id="sortableHead">
            ...
            <th data-column-index="8">
                <div data-name="marca" data-ordem="{{$ordem ?? 'desc'}}" class="th-content th-coluna">Marca</div>
            </th>
    ...
    <tbody class="sortable">
        @foreach ($demandas as $demanda )
            <tr data-key="{{$demanda->id}}" class="trLink" style="cursor: pointer;" data-href="{{route('Job', ['id' => $demanda->id])}}">
                ...
                @else
                <td data-date="{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $demanda->final)->format('d/m/Y H:i:s'); }}"  data-column-index="5">

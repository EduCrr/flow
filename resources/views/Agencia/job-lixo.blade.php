                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="mb-3 no-margin">
                                                                                                    ...
                                                                                                    <textarea class="ckText" id="modalEl" name="newContent"></textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="mb-3 no-margin">
                                                                                                    ...
                                                                                                    <textarea  class="ckText" id="answerModal" name="newContent"></textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="mb-3" id="alteracao">
                                                                            ...
                                                                            @if ($loggedUser->id == $demanda->criador_id)
                                                                                ...
                                                                                @endif
                                                                            @endif
                                                                            <textarea id="modalComentaryUser" class="ckText" name="conteudo">{{ old('conteudo') 
                                                                            }}</textarea>
                                                                        </div>          
                                                                    </div>
                                                                </div>

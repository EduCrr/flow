                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <ul id="sortableColumns" class="list-group">
                                                            ...
                                                            <li class="list-group-item" data-column-index="8">Marca</li>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="table-responsive" id="jobOrdem">
                                                <div class="d-flex justify-content-center loadingHelper" style="height: 15px; margin-bottom: 25px">
...
<script>
   ...
   $(document).ready(function() {
        ...
        $('#pagination').on('change', function() {
            ...
            updatePaginationParams("/agencia/ordem", true);
        });
    });

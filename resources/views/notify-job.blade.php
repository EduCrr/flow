										...
										<tbody>
											...
											<tr>
												<td style="padding-top:10px;padding-bottom:20px" align="center" valign="middle">
													<img src="{{ asset('/assets/images/logo8.png') }}" width="150">
												</td>
											</tr>
											<tr>
																						...
																						<tbody>
																							<tr>
																								<td valign="top">
																									...
																									@if(isset($mensagem))
																										<h3 style="margin:0px 0px 10px 0px;padding:0px;color:#252525;font-style:normal;font-size:25px;font-family:Calibri,Helvetica,Arial,sans-serif;font-weight:400;line-height:40px;text-decoration:none;text-transform:none;display:block;text-align:center;">Comentário:</h3>
																										<div style="box-sizing:border-box;margin:0;padding:20px; background-color: #f1f1f1">
																											<p style="margin:0px 0px 15px 0px;padding:0px;color:#252525;font-style:normal;font-size:14px;font-family:Calibri,Helvetica,Arial,sans-serif;font-weight:400;line-height:25px;text-decoration:none;text-transform:none;display:flex;text-align:left;">
																												{!! $mensagem !!}
																											</p>
																											<p style="margin:0px 0px 15px 0px;padding:0px;color:#252525;font-style:normal;font-size:14px;font-family:Calibri,Helvetica,Arial,sans-serif;font-weight:400;line-height:25px;text-decoration:none;text-transform:none;text-align:left;">
																												Enviado por: <strong> {!! $nomeUsuario !!} </strong>
																											</p>
																										</div>
																										<br/>
																									@endif
